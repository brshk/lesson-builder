...
const uk = {
  ...
  // профіль групи
  groupSection: "Профіль групи",
  groupHint: "Той самий урок для різних груп має бути різним — заповніть, і матеріали адаптуються.",
  ageLabel: "Вік",
  ageFrom: "від",
  ageTo: "до",
  studentsLabel: "Студентів",
  levelLabel: "Рівень групи",
  levelWeak: "Слабкий",
  levelMixed: "Змішаний",
  levelStrong: "Сильний",
  hardwareLabel: "Обладнання",
  hardwarePlaceholder: "Напр.: Windows PC, проєктор",
  priorLabel: "Що група вже знає",
  priorPlaceholder: "Напр.: змінні, цикли, перший проєкт у Scratch",
  savedGroups: "Збережені групи",
  saveGroup: "Зберегти групу",
  groupNamePlaceholder: "Назва групи, напр. МКА-11 Python",
  deleteGroup: "Видалити",
  groupSaved: "Групу збережено",

  // AI-редактор
  editorTitle: "AI-редактор",
  editorHint: "Наведіть на блок — з'являться дії. Або напишіть у чаті, що змінити.",
  actSimpler: "Простіше",
  actHarder: "Складніше",
  actMorePractice: "Більше практики",
  actShorter: "Скоротити",
  actAddGame: "Додати гру",
  actAdaptOnline: "Адаптувати онлайн",
  actAdaptOffline: "Адаптувати офлайн",
  actReplacePaid: "Замінити платний сервіс",
  actRegenerate: "Перегенерувати блок",
  editingBlock: "Переробляю блок…",
  editingDoc: "Переробляю урок…",
  undo: "Скасувати",
  undoDone: "Правку скасовано",
  chatPlaceholder: "Що змінити? Напр.: «У мене слабша група, перероби практику»",
  chatApply: "Застосувати",
  chatTarget: "Застосувати до",
  wholeLesson: "усього уроку",

  // відповідність програмі
  complianceTitle: "Відповідність програмі",
  checkCompliance: "Перевірити відповідність програмі",
  recheck: "Перевірити ще раз",
  checking: "Звіряю з програмою…",
  noCurriculumBound: "Навчальну програму не прив'язано, тож відсоток рахувати немає від чого. Оберіть курс із позначкою 📘 — і перевірка стане доступною.",
  curriculumItems: "Пункти програми за темою",
  covered: "розкрито",
  notCovered: "не розкрито",
  outcomesTitle: "Результати навчання",
  aiAddedTitle: "Додано AI понад програму",
  outOfScopeTitle: "Виходить за межі затвердженої програми",
  coverageNote: "Відсоток = розкриті пункти ÷ пункти програми за цією темою.",
  allCovered: "Усі пункти програми за темою розкрито.",
  inBlocks: "у блоках",
  required: "*",
};
...
const ru: Dict = {
  ...
  groupSection: "Профиль группы",
  groupHint: "Один и тот же урок для разных групп должен быть разным — заполните, и материалы адаптируются.",
  ageLabel: "Возраст",
  ageFrom: "от",
  ageTo: "до",
  studentsLabel: "Студентов",
  levelLabel: "Уровень группы",
  levelWeak: "Слабый",
  levelMixed: "Смешанный",
  levelStrong: "Сильный",
  hardwareLabel: "Оборудование",
  hardwarePlaceholder: "Напр.: Windows PC, проектор",
  priorLabel: "Что группа уже знает",
  priorPlaceholder: "Напр.: переменные, циклы, первый проект в Scratch",
  savedGroups: "Сохранённые группы",
  saveGroup: "Сохранить группу",
  groupNamePlaceholder: "Название группы, напр. МКА-11 Python",
  deleteGroup: "Удалить",
  groupSaved: "Группа сохранена",

  editorTitle: "AI-редактор",
  editorHint: "Наведите на блок — появятся действия. Или напишите в чате, что изменить.",
  actSimpler: "Проще",
  actHarder: "Сложнее",
  actMorePractice: "Больше практики",
  actShorter: "Сократить",
  actAddGame: "Добавить игру",
  actAdaptOnline: "Адаптировать онлайн",
  actAdaptOffline: "Адаптировать офлайн",
  actReplacePaid: "Заменить платный сервис",
  actRegenerate: "Перегенерировать блок",
  editingBlock: "Переделываю блок…",
  editingDoc: "Переделываю урок…",
  undo: "Отменить",
  undoDone: "Правка отменена",
  chatPlaceholder: "Что изменить? Напр.: «У меня группа слабее, переделай практику»",
  chatApply: "Применить",
  chatTarget: "Применить к",
  wholeLesson: "всему уроку",

  complianceTitle: "Соответствие программе",
  checkCompliance: "Проверить соответствие программе",
  recheck: "Проверить ещё раз",
  checking: "Сверяю с программой…",
  noCurriculumBound: "Учебная программа не привязана, поэтому процент считать не от чего. Выберите курс с отметкой 📘 — и проверка станет доступной.",
  curriculumItems: "Пункты программы по теме",
  covered: "раскрыто",
  notCovered: "не раскрыто",
  outcomesTitle: "Результаты обучения",
  aiAddedTitle: "Добавлено AI сверх программы",
  outOfScopeTitle: "Выходит за пределы утверждённой программы",
  coverageNote: "Процент = раскрытые пункты ÷ пункты программы по этой теме.",
  allCovered: "Все пункты программы по теме раскрыты.",
  inBlocks: "в блоках",
  required: "*",
};
...
const en: Dict = {
  ...
  groupSection: "Group profile",
  groupHint: "The same lesson should differ between groups — fill this in and the materials adapt.",
  ageLabel: "Age",
  ageFrom: "from",
  ageTo: "to",
  studentsLabel: "Students",
  levelLabel: "Group level",
  levelWeak: "Struggling",
  levelMixed: "Mixed",
  levelStrong: "Strong",
  hardwareLabel: "Hardware",
  hardwarePlaceholder: "e.g. Windows PCs, projector",
  priorLabel: "What the group already knows",
  priorPlaceholder: "e.g. variables, loops, first Scratch project",
  savedGroups: "Saved groups",
  saveGroup: "Save group",
  groupNamePlaceholder: "Group name, e.g. JCA-11 Python",
  deleteGroup: "Delete",
  groupSaved: "Group saved",

  editorTitle: "AI editor",
  editorHint: "Hover a block for actions. Or tell the chat what to change.",
  actSimpler: "Simpler",
  actHarder: "Harder",
  actMorePractice: "More practice",
  actShorter: "Shorten",
  actAddGame: "Add a game",
  actAdaptOnline: "Adapt for online",
  actAdaptOffline: "Adapt for in-person",
  actReplacePaid: "Replace paid tool",
  actRegenerate: "Regenerate block",
  editingBlock: "Reworking the block…",
  editingDoc: "Reworking the lesson…",
  undo: "Undo",
  undoDone: "Change undone",
  chatPlaceholder: "What should change? e.g. “My group is weaker, rework the practice”",
  chatApply: "Apply",
  chatTarget: "Apply to",
  wholeLesson: "the whole lesson",

  complianceTitle: "Curriculum coverage",
  checkCompliance: "Check against the curriculum",
  recheck: "Check again",
  checking: "Comparing with the curriculum…",
  noCurriculumBound: "No curriculum is linked, so there is nothing to compute a percentage against. Pick a course marked 📘 and the check becomes available.",
  curriculumItems: "Curriculum points for this topic",
  covered: "covered",
  notCovered: "not covered",
  outcomesTitle: "Learning outcomes",
  aiAddedTitle: "Added by AI beyond the curriculum",
  outOfScopeTitle: "Outside the approved curriculum",
  coverageNote: "Percentage = covered points ÷ curriculum points for this topic.",
  allCovered: "Every curriculum point for this topic is covered.",
  inBlocks: "in blocks",
  required: "*",
};
...
const GROUP_I18N: Record<string, Partial<Record<UiLang, string>>> = {
  ...
  "Курси для професіоналів": {
    ru: "Курсы для профессионалов",
